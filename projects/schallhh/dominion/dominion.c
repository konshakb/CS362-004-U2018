...
int mineEffect(int currentPlayer, struct gameState* state, int choice1, int choice2, int handPos, int i, int j)
{
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState* state, int handPos, int* bonus)
{
    ...
    case mine:
        return mineEffect(currentPlayer, state, choice1, choice2, handPos, i, j);
